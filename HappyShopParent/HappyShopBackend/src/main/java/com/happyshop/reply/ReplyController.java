...
public class ReplyController {
    ...
    private String saveAnswer(@RequestParam("content") String content,
            @RequestParam("questionId") Integer questionId,
            @RequestParam("replyIdNeedAnswer") Integer replyIdNeedAnswer,
            RedirectAttributes re,
        ...
        Reply replyNeedAnswer = replyService.findById(replyIdNeedAnswer).get();
        replyNeedAnswer.setAdminReplyRequired(false);
        ...
        replyService.save(r);
        re.addFlashAttribute("message", "Answer reply id " + replyIdNeedAnswer +" successfully!");                        
        
        return "redirect:/reply/page/1?sortField=replyTime&sortDir=des&keyWord=&replyStatus=ARR";
    }
